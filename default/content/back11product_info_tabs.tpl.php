...
<h1 class="no-margin-top"><?php echo tep_get_manufacturers_name($product_info['manufacturers_id']); ?></h1>
...
<span class="content-products-info-price pull-left lt-blue"><?php echo $products_price; ?></span>
      ...
      <div class="content-products-info-reviews-container large-margin-bottom">
        ...
        <span class="content-products-info-reviews-rating margin-right"><?php echo tep_get_manufacturers_name($product_info['manufacturers_id']); ?>(<?php echo TEXT_MANUFACTURER;?>)</span>
	  </div>
                  <?php
                    $hide_add_to_cart = hide_add_to_cart();
                    if ($hide_add_to_cart == 'false' && group_hide_show_prices() == 'true') {
            ...
            <label class="content-products-info-qty-label"><?php echo TEXT_ENTER_QUANTITY,':'; ?></label>
                    <?php echo  tep_draw_input_field('cart_quantity', '1', 'size="4" maxlength="4" id="Qty1" onkeyup="document.getElementById(\'Qty2\').value = document.getElementById(\'Qty1\').value;"  ');?>
