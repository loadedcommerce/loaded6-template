<?php
/*
  $Id: FSS_checkoutprocess_logic.php,v 1.0.0 2008/05/22 13:41:11 Eversun Exp $
...
if (defined('MODULE_ADDONS_FSS_STATUS') && MODULE_ADDONS_FSS_STATUS == 'True') {
  if ( isset($_POST['forms_id']) && tep_not_null($_POST['forms_id']) ) {
    ...
    if (tep_db_num_rows($forms_query) > 0) {
      ...
      tep_db_query("insert into " . TABLE_FSS_FORMS_POSTS . " (forms_id, posts_date, orders_id) values ('" . $forms_id . "', now(), '" . $insert_id . "')");
